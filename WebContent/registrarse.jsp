    ...
    <body>
        ...
        <form  action="registrarse" method="post">
                ...
                <TABLE>
                    ...
                    <TR>
                        <TD>Nombre:</TD>
                        <TD> <input type="text" name="nombre" size=18 maxlength=18> 
                        	Apellido:
                      ...
                      <tr>
                        <TD> 
                        	Carrera:
                            <input type="text" name="carrera" size=18 maxlength=18> 
                        </TD>
                        <tr>
                        <TD> 
                        	Anos de Carrera:
                            <input type="text" name="aCarrera" size=18 maxlength=18> 
                        </TD>
                    ...
                    <tr>
                    	<td>Password: </td>
                    	<TD> <textarea name="password" size="10" maxlength=10 ></textarea></TD>
